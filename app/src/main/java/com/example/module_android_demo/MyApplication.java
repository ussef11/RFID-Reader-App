...
public class MyApplication extends Application {
	...
	public static String Constr_INVENTORY = "扫描";
	 ...
	 * 公共变量 public var
	 */
	public Map<String, TAGINFO> TagsMap = new LinkedHashMap<String, TAGINFO>();// 有序 sorted
	public ArrayList<String> mfiltags=new ArrayList<String>();
	public String path;
